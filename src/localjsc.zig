...
pub const kJSTypeBigInt: c_int = 7;
...
pub const kJSRelationConditionUndefined: c_int = 0;
pub const kJSRelationConditionEqual: c_int = 1;
pub const kJSRelationConditionGreaterThan: c_int = 2;
pub const kJSRelationConditionLessThan: c_int = 3;
pub const JSRelationCondition = c_uint;
...
pub extern fn JSValueIsBigInt(ctx: JSContextRef, value: JSValueRef) bool;
...
pub extern fn JSValueCompare(ctx: JSContextRef, left: JSValueRef, right: JSValueRef, exception: [*c]JSValueRef) JSRelationCondition;
pub extern fn JSValueCompareInt64(ctx: JSContextRef, left: JSValueRef, right: i64, exception: [*c]JSValueRef) JSRelationCondition;
pub extern fn JSValueCompareUInt64(ctx: JSContextRef, left: JSValueRef, right: u64, exception: [*c]JSValueRef) JSRelationCondition;
pub extern fn JSValueCompareDouble(ctx: JSContextRef, left: JSValueRef, right: f64, exception: [*c]JSValueRef) JSRelationCondition;
...
pub extern fn JSBigIntCreateWithDouble(ctx: JSContextRef, value: f64, exception: [*c]JSValueRef) JSValueRef;
pub extern fn JSBigIntCreateWithInt64(ctx: JSContextRef, integer: i64, exception: [*c]JSValueRef) JSValueRef;
pub extern fn JSBigIntCreateWithUInt64(ctx: JSContextRef, integer: u64, exception: [*c]JSValueRef) JSValueRef;
pub extern fn JSBigIntCreateWithString(ctx: JSContextRef, string: JSStringRef, exception: [*c]JSValueRef) JSValueRef;
...
pub extern fn JSValueToInt32(ctx: JSContextRef, value: JSValueRef, exception: [*c]JSValueRef) i32;
pub extern fn JSValueToUInt32(ctx: JSContextRef, value: JSValueRef, exception: [*c]JSValueRef) u32;
pub extern fn JSValueToInt64(ctx: JSContextRef, value: JSValueRef, exception: [*c]JSValueRef) i64;
pub extern fn JSValueToUInt64(ctx: JSContextRef, value: JSValueRef, exception: [*c]JSValueRef) u64;
...
// ./jsc/JavaScriptCore/JSBase.h:91:9
pub const JSC_OBJC_API_ENABLED = @as(c_int, 0);
pub const JSC_CF_ENUM = @compileError("unable to translate C expr: expected ')' instead got '...'");
// ./jsc/JavaScriptCore/JSBase.h:161:9
pub const JSC_ASSUME_NONNULL_BEGIN = "";
pub const JSC_ASSUME_NONNULL_END = "";
pub const JSC_NULL_UNSPECIFIED = "";
pub const JSC_NULLABLE = "";
pub const JSC_NONNULL = "";
