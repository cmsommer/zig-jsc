...
pub const struct__GTypeValueTable = extern struct {
    value_init: ?*const fn ([*c]GValue) callconv(.C) void = @import("std").mem.zeroes(?*const fn ([*c]GValue) callconv(.C) void),
    value_free: ?*const fn ([*c]GValue) callconv(.C) void = @import("std").mem.zeroes(?*const fn ([*c]GValue) callconv(.C) void),
    value_copy: ?*const fn ([*c]const GValue, [*c]GValue) callconv(.C) void = @import("std").mem.zeroes(?*const fn ([*c]const GValue, [*c]GValue) callconv(.C) void),
    value_peek_pointer: ?*const fn ([*c]const GValue) callconv(.C) gpointer = @import("std").mem.zeroes(?*const fn ([*c]const GValue) callconv(.C) gpointer),
    collect_format: [*c]const gchar = @import("std").mem.zeroes([*c]const gchar),
    collect_value: ?*const fn ([*c]GValue, guint, ?*GTypeCValue, guint) callconv(.C) [*c]gchar = @import("std").mem.zeroes(?*const fn ([*c]GValue, guint, ?*GTypeCValue, guint) callconv(.C) [*c]gchar),
    lcopy_format: [*c]const gchar = @import("std").mem.zeroes([*c]const gchar),
    lcopy_value: ?*const fn ([*c]const GValue, guint, ?*GTypeCValue, guint) callconv(.C) [*c]gchar = @import("std").mem.zeroes(?*const fn ([*c]const GValue, guint, ?*GTypeCValue, guint) callconv(.C) [*c]gchar),
};
...
pub const struct__GParamSpecClass = extern struct {
    ...
    dummy: [4]gpointer = @import("std").mem.zeroes([4]gpointer),
};
...
// /usr/include/glib-2.0/gobject/gclosure.h:182:9: warning: struct demoted to opaque type - has bitfield
...
pub const struct__GObjectClass = extern struct {
    ...
    pdummy: [6]gpointer = @import("std").mem.zeroes([6]gpointer),
};
...
pub fn g_assert_finalize_object(arg_object: [*c]GObject) callconv(.C) void {
    ...
    while (true) {
        if (g_type_check_instance_is_fundamentally_a(@as([*c]GTypeInstance, @ptrCast(@alignCast(weak_pointer))), @as(GType, @bitCast(@as(c_long, @as(c_int, 20) << @intCast(@as(c_int, 2)))))) != 0) {} else {
            g_assertion_message(@as([*c]gchar, @ptrFromInt(@as(c_int, 0))), "/usr/include/glib-2.0/gobject/gobject.h", @as(c_int, 812), "g_assert_finalize_object", "'G_IS_OBJECT (weak_pointer)' should be TRUE");
        }
        if (!false) break;
    }
    ...
    while (true) {
        if (weak_pointer == @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))) {} else {
            g_assertion_message(@as([*c]gchar, @ptrFromInt(@as(c_int, 0))), "/usr/include/glib-2.0/gobject/gobject.h", @as(c_int, 815), "g_assert_finalize_object", "'weak_pointer' should be NULL");
        }
        if (!false) break;
    }
}
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:865:17: warning: struct demoted to opaque type - has bitfield
...
pub extern fn jsc_value_get_type() GType;
pub const struct__JSCValue = opaque {};
pub const JSCValue = struct__JSCValue;
pub const JSCValueClass = extern struct {
    parent_class: GObjectClass = @import("std").mem.zeroes(GObjectClass),
};
pub const JSCValue_autoptr = ?*JSCValue;
pub const JSCValue_listautoptr = [*c]GList;
pub const JSCValue_slistautoptr = [*c]GSList;
pub const JSCValue_queueautoptr = [*c]GQueue;
pub fn glib_autoptr_clear_JSCValue(arg__ptr: ?*JSCValue) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    if (_ptr != null) {
...
pub fn glib_autoptr_cleanup_JSCValue(arg__ptr: [*c]?*JSCValue) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    glib_autoptr_clear_JSCValue(_ptr.*);
}
pub fn glib_listautoptr_cleanup_JSCValue(arg__l: [*c][*c]GList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
...
pub fn glib_slistautoptr_cleanup_JSCValue(arg__l: [*c][*c]GSList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
...
pub fn glib_queueautoptr_cleanup_JSCValue(arg__q: [*c][*c]GQueue) callconv(.C) void {
    var _q = arg__q;
    _ = &_q;
    if (_q.* != null) {
...
pub const JSCValueClass_autoptr = [*c]JSCValueClass;
pub const JSCValueClass_listautoptr = [*c]GList;
pub const JSCValueClass_slistautoptr = [*c]GSList;
pub const JSCValueClass_queueautoptr = [*c]GQueue;
pub fn glib_autoptr_clear_JSCValueClass(arg__ptr: [*c]JSCValueClass) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    if (_ptr != null) {
        g_type_class_unref(@as(gpointer, @ptrCast(_ptr)));
...
pub fn glib_autoptr_cleanup_JSCValueClass(arg__ptr: [*c][*c]JSCValueClass) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    glib_autoptr_clear_JSCValueClass(_ptr.*);
}
pub fn glib_listautoptr_cleanup_JSCValueClass(arg__l: [*c][*c]GList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_list_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&g_type_class_unref)))))));
}
pub fn glib_slistautoptr_cleanup_JSCValueClass(arg__l: [*c][*c]GSList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_slist_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&g_type_class_unref)))))));
}
pub fn glib_queueautoptr_cleanup_JSCValueClass(arg__q: [*c][*c]GQueue) callconv(.C) void {
    var _q = arg__q;
    _ = &_q;
    if (_q.* != null) {
        g_queue_free_full(_q.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&g_type_class_unref)))))));
...
pub fn JSC_VALUE(arg_ptr: gpointer) callconv(.C) ?*JSCValue {
    var ptr = arg_ptr;
    _ = &ptr;
    return @as(?*JSCValue, @ptrCast(@as(?*anyopaque, @ptrCast(g_type_check_instance_cast(@as([*c]GTypeInstance, @ptrCast(@alignCast(ptr))), jsc_value_get_type())))));
}
pub fn JSC_IS_VALUE(arg_ptr: gpointer) callconv(.C) gboolean {
    var ptr = arg_ptr;
    _ = &ptr;
    return blk: {
        var __inst: [*c]GTypeInstance = @as([*c]GTypeInstance, @ptrCast(@alignCast(ptr)));
        _ = &__inst;
        var __t: GType = jsc_value_get_type();
        _ = &__t;
...
pub const struct__JSCClass = opaque {};
pub const JSCClass = struct__JSCClass;
pub const struct__JSCContext = opaque {};
pub const JSCContext = struct__JSCContext;
pub const JSC_VALUE_PROPERTY_CONFIGURABLE: c_int = 1;
pub const JSC_VALUE_PROPERTY_ENUMERABLE: c_int = 2;
pub const JSC_VALUE_PROPERTY_WRITABLE: c_int = 4;
pub const JSCValuePropertyFlags = c_uint;
pub const JSC_TYPED_ARRAY_NONE: c_int = 0;
pub const JSC_TYPED_ARRAY_INT8: c_int = 1;
pub const JSC_TYPED_ARRAY_INT16: c_int = 2;
pub const JSC_TYPED_ARRAY_INT32: c_int = 3;
pub const JSC_TYPED_ARRAY_INT64: c_int = 4;
pub const JSC_TYPED_ARRAY_UINT8: c_int = 5;
pub const JSC_TYPED_ARRAY_UINT8_CLAMPED: c_int = 6;
pub const JSC_TYPED_ARRAY_UINT16: c_int = 7;
pub const JSC_TYPED_ARRAY_UINT32: c_int = 8;
pub const JSC_TYPED_ARRAY_UINT64: c_int = 9;
pub const JSC_TYPED_ARRAY_FLOAT32: c_int = 10;
pub const JSC_TYPED_ARRAY_FLOAT64: c_int = 11;
pub const JSCTypedArrayType = c_uint;
pub extern fn jsc_value_get_context(value: ?*JSCValue) ?*JSCContext;
pub extern fn jsc_value_new_undefined(context: ?*JSCContext) ?*JSCValue;
pub extern fn jsc_value_is_undefined(value: ?*JSCValue) gboolean;
pub extern fn jsc_value_new_null(context: ?*JSCContext) ?*JSCValue;
pub extern fn jsc_value_is_null(value: ?*JSCValue) gboolean;
pub extern fn jsc_value_new_number(context: ?*JSCContext, number: f64) ?*JSCValue;
pub extern fn jsc_value_is_number(value: ?*JSCValue) gboolean;
pub extern fn jsc_value_to_double(value: ?*JSCValue) f64;
pub extern fn jsc_value_to_int32(value: ?*JSCValue) gint32;
pub extern fn jsc_value_new_boolean(context: ?*JSCContext, value: gboolean) ?*JSCValue;
pub extern fn jsc_value_is_boolean(value: ?*JSCValue) gboolean;
pub extern fn jsc_value_to_boolean(value: ?*JSCValue) gboolean;
pub extern fn jsc_value_new_string(context: ?*JSCContext, string: [*c]const u8) ?*JSCValue;
pub extern fn jsc_value_new_string_from_bytes(context: ?*JSCContext, bytes: ?*GBytes) ?*JSCValue;
pub extern fn jsc_value_is_string(value: ?*JSCValue) gboolean;
pub extern fn jsc_value_to_string(value: ?*JSCValue) [*c]u8;
pub extern fn jsc_value_to_string_as_bytes(value: ?*JSCValue) ?*GBytes;
pub extern fn jsc_value_new_array(context: ?*JSCContext, first_item_type: GType, ...) ?*JSCValue;
pub extern fn jsc_value_new_array_from_garray(context: ?*JSCContext, array: [*c]GPtrArray) ?*JSCValue;
pub extern fn jsc_value_new_array_from_strv(context: ?*JSCContext, strv: [*c]const [*c]const u8) ?*JSCValue;
pub extern fn jsc_value_is_array(value: ?*JSCValue) gboolean;
pub extern fn jsc_value_new_object(context: ?*JSCContext, instance: gpointer, jsc_class: ?*JSCClass) ?*JSCValue;
pub extern fn jsc_value_is_object(value: ?*JSCValue) gboolean;
pub extern fn jsc_value_object_is_instance_of(value: ?*JSCValue, name: [*c]const u8) gboolean;
pub extern fn jsc_value_object_set_property(value: ?*JSCValue, name: [*c]const u8, property: ?*JSCValue) void;
pub extern fn jsc_value_object_get_property(value: ?*JSCValue, name: [*c]const u8) ?*JSCValue;
pub extern fn jsc_value_object_set_property_at_index(value: ?*JSCValue, index: guint, property: ?*JSCValue) void;
pub extern fn jsc_value_object_get_property_at_index(value: ?*JSCValue, index: guint) ?*JSCValue;
pub extern fn jsc_value_object_has_property(value: ?*JSCValue, name: [*c]const u8) gboolean;
pub extern fn jsc_value_object_delete_property(value: ?*JSCValue, name: [*c]const u8) gboolean;
pub extern fn jsc_value_object_enumerate_properties(value: ?*JSCValue) [*c][*c]gchar;
pub extern fn jsc_value_object_invoke_method(value: ?*JSCValue, name: [*c]const u8, first_parameter_type: GType, ...) ?*JSCValue;
pub extern fn jsc_value_object_invoke_methodv(value: ?*JSCValue, name: [*c]const u8, n_parameters: guint, parameters: [*c]?*JSCValue) ?*JSCValue;
pub extern fn jsc_value_object_define_property_data(value: ?*JSCValue, property_name: [*c]const u8, flags: JSCValuePropertyFlags, property_value: ?*JSCValue) void;
pub extern fn jsc_value_object_define_property_accessor(value: ?*JSCValue, property_name: [*c]const u8, flags: JSCValuePropertyFlags, property_type: GType, getter: GCallback, setter: GCallback, user_data: gpointer, destroy_notify: GDestroyNotify) void;
pub extern fn jsc_value_new_function(context: ?*JSCContext, name: [*c]const u8, callback: GCallback, user_data: gpointer, destroy_notify: GDestroyNotify, return_type: GType, n_params: guint, ...) ?*JSCValue;
pub extern fn jsc_value_new_functionv(context: ?*JSCContext, name: [*c]const u8, callback: GCallback, user_data: gpointer, destroy_notify: GDestroyNotify, return_type: GType, n_parameters: guint, parameter_types: [*c]GType) ?*JSCValue;
pub extern fn jsc_value_new_function_variadic(context: ?*JSCContext, name: [*c]const u8, callback: GCallback, user_data: gpointer, destroy_notify: GDestroyNotify, return_type: GType) ?*JSCValue;
pub extern fn jsc_value_is_function(value: ?*JSCValue) gboolean;
pub extern fn jsc_value_function_call(value: ?*JSCValue, first_parameter_type: GType, ...) ?*JSCValue;
pub extern fn jsc_value_function_callv(value: ?*JSCValue, n_parameters: guint, parameters: [*c]?*JSCValue) ?*JSCValue;
pub extern fn jsc_value_new_array_buffer(context: ?*JSCContext, data: gpointer, size: gsize, destroy_notify: GDestroyNotify, user_data: gpointer) ?*JSCValue;
pub extern fn jsc_value_is_array_buffer(value: ?*JSCValue) gboolean;
pub extern fn jsc_value_array_buffer_get_data(value: ?*JSCValue, size: [*c]gsize) gpointer;
pub extern fn jsc_value_array_buffer_get_size(value: ?*JSCValue) gsize;
pub extern fn jsc_value_new_typed_array(context: ?*JSCContext, @"type": JSCTypedArrayType, length: gsize) ?*JSCValue;
pub extern fn jsc_value_new_typed_array_with_buffer(array_buffer: ?*JSCValue, @"type": JSCTypedArrayType, offset: gsize, length: gssize) ?*JSCValue;
pub extern fn jsc_value_is_typed_array(value: ?*JSCValue) gboolean;
pub extern fn jsc_value_typed_array_get_type(value: ?*JSCValue) JSCTypedArrayType;
pub extern fn jsc_value_typed_array_get_data(value: ?*JSCValue, length: [*c]gsize) gpointer;
pub extern fn jsc_value_typed_array_get_length(value: ?*JSCValue) gsize;
pub extern fn jsc_value_typed_array_get_size(value: ?*JSCValue) gsize;
pub extern fn jsc_value_typed_array_get_offset(value: ?*JSCValue) gsize;
pub extern fn jsc_value_typed_array_get_buffer(value: ?*JSCValue) ?*JSCValue;
pub extern fn jsc_value_is_constructor(value: ?*JSCValue) gboolean;
pub extern fn jsc_value_constructor_call(value: ?*JSCValue, first_parameter_type: GType, ...) ?*JSCValue;
pub extern fn jsc_value_constructor_callv(value: ?*JSCValue, n_parameters: guint, parameters: [*c]?*JSCValue) ?*JSCValue;
pub extern fn jsc_value_new_from_json(context: ?*JSCContext, json: [*c]const u8) ?*JSCValue;
pub extern fn jsc_value_to_json(value: ?*JSCValue, indent: guint) [*c]u8;
pub extern fn jsc_class_get_type() GType;
pub const JSCClassClass = extern struct {
    parent_class: GObjectClass = @import("std").mem.zeroes(GObjectClass),
};
pub const JSCClass_autoptr = ?*JSCClass;
pub const JSCClass_listautoptr = [*c]GList;
pub const JSCClass_slistautoptr = [*c]GSList;
pub const JSCClass_queueautoptr = [*c]GQueue;
pub fn glib_autoptr_clear_JSCClass(arg__ptr: ?*JSCClass) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    if (_ptr != null) {
        glib_autoptr_clear_GObject(@as([*c]GObject, @ptrCast(@alignCast(_ptr))));
...
pub fn glib_autoptr_cleanup_JSCClass(arg__ptr: [*c]?*JSCClass) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    glib_autoptr_clear_JSCClass(_ptr.*);
}
pub fn glib_listautoptr_cleanup_JSCClass(arg__l: [*c][*c]GList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_list_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&glib_autoptr_clear_GObject)))))));
}
pub fn glib_slistautoptr_cleanup_JSCClass(arg__l: [*c][*c]GSList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_slist_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&glib_autoptr_clear_GObject)))))));
}
pub fn glib_queueautoptr_cleanup_JSCClass(arg__q: [*c][*c]GQueue) callconv(.C) void {
    var _q = arg__q;
    _ = &_q;
    if (_q.* != null) {
        g_queue_free_full(_q.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&glib_autoptr_clear_GObject)))))));
...
pub const JSCClassClass_autoptr = [*c]JSCClassClass;
pub const JSCClassClass_listautoptr = [*c]GList;
pub const JSCClassClass_slistautoptr = [*c]GSList;
pub const JSCClassClass_queueautoptr = [*c]GQueue;
pub fn glib_autoptr_clear_JSCClassClass(arg__ptr: [*c]JSCClassClass) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    if (_ptr != null) {
        g_type_class_unref(@as(gpointer, @ptrCast(_ptr)));
...
pub fn glib_autoptr_cleanup_JSCClassClass(arg__ptr: [*c][*c]JSCClassClass) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    glib_autoptr_clear_JSCClassClass(_ptr.*);
}
pub fn glib_listautoptr_cleanup_JSCClassClass(arg__l: [*c][*c]GList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_list_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&g_type_class_unref)))))));
}
pub fn glib_slistautoptr_cleanup_JSCClassClass(arg__l: [*c][*c]GSList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_slist_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&g_type_class_unref)))))));
}
pub fn glib_queueautoptr_cleanup_JSCClassClass(arg__q: [*c][*c]GQueue) callconv(.C) void {
    var _q = arg__q;
    _ = &_q;
    if (_q.* != null) {
        g_queue_free_full(_q.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&g_type_class_unref)))))));
...
pub fn JSC_CLASS(arg_ptr: gpointer) callconv(.C) ?*JSCClass {
    var ptr = arg_ptr;
    _ = &ptr;
    return @as(?*JSCClass, @ptrCast(@as(?*anyopaque, @ptrCast(g_type_check_instance_cast(@as([*c]GTypeInstance, @ptrCast(@alignCast(ptr))), jsc_class_get_type())))));
}
pub fn JSC_IS_CLASS(arg_ptr: gpointer) callconv(.C) gboolean {
    var ptr = arg_ptr;
    _ = &ptr;
    return blk: {
        var __inst: [*c]GTypeInstance = @as([*c]GTypeInstance, @ptrCast(@alignCast(ptr)));
        _ = &__inst;
        var __t: GType = jsc_class_get_type();
        _ = &__t;
        var __r: gboolean = undefined;
        _ = &__r;
        if (!(__inst != null)) {
...
pub const JSCClassGetPropertyFunction = ?*const fn (?*JSCClass, ?*JSCContext, gpointer, [*c]const u8) callconv(.C) ?*JSCValue;
pub const JSCClassSetPropertyFunction = ?*const fn (?*JSCClass, ?*JSCContext, gpointer, [*c]const u8, ?*JSCValue) callconv(.C) gboolean;
pub const JSCClassHasPropertyFunction = ?*const fn (?*JSCClass, ?*JSCContext, gpointer, [*c]const u8) callconv(.C) gboolean;
pub const JSCClassDeletePropertyFunction = ?*const fn (?*JSCClass, ?*JSCContext, gpointer, [*c]const u8) callconv(.C) gboolean;
pub const JSCClassEnumeratePropertiesFunction = ?*const fn (?*JSCClass, ?*JSCContext, gpointer) callconv(.C) [*c][*c]gchar;
pub const JSCClassVTable = extern struct {
    get_property: JSCClassGetPropertyFunction = @import("std").mem.zeroes(JSCClassGetPropertyFunction),
    set_property: JSCClassSetPropertyFunction = @import("std").mem.zeroes(JSCClassSetPropertyFunction),
    has_property: JSCClassHasPropertyFunction = @import("std").mem.zeroes(JSCClassHasPropertyFunction),
    delete_property: JSCClassDeletePropertyFunction = @import("std").mem.zeroes(JSCClassDeletePropertyFunction),
    enumerate_properties: JSCClassEnumeratePropertiesFunction = @import("std").mem.zeroes(JSCClassEnumeratePropertiesFunction),
    _jsc_reserved0: ?*const fn () callconv(.C) void = @import("std").mem.zeroes(?*const fn () callconv(.C) void),
    _jsc_reserved1: ?*const fn () callconv(.C) void = @import("std").mem.zeroes(?*const fn () callconv(.C) void),
    _jsc_reserved2: ?*const fn () callconv(.C) void = @import("std").mem.zeroes(?*const fn () callconv(.C) void),
    _jsc_reserved3: ?*const fn () callconv(.C) void = @import("std").mem.zeroes(?*const fn () callconv(.C) void),
    _jsc_reserved4: ?*const fn () callconv(.C) void = @import("std").mem.zeroes(?*const fn () callconv(.C) void),
    _jsc_reserved5: ?*const fn () callconv(.C) void = @import("std").mem.zeroes(?*const fn () callconv(.C) void),
    _jsc_reserved6: ?*const fn () callconv(.C) void = @import("std").mem.zeroes(?*const fn () callconv(.C) void),
    _jsc_reserved7: ?*const fn () callconv(.C) void = @import("std").mem.zeroes(?*const fn () callconv(.C) void),
};
pub extern fn jsc_class_get_name(jsc_class: ?*JSCClass) [*c]const u8;
pub extern fn jsc_class_get_parent(jsc_class: ?*JSCClass) ?*JSCClass;
pub extern fn jsc_class_add_constructor(jsc_class: ?*JSCClass, name: [*c]const u8, callback: GCallback, user_data: gpointer, destroy_notify: GDestroyNotify, return_type: GType, n_params: guint, ...) ?*JSCValue;
pub extern fn jsc_class_add_constructorv(jsc_class: ?*JSCClass, name: [*c]const u8, callback: GCallback, user_data: gpointer, destroy_notify: GDestroyNotify, return_type: GType, n_parameters: guint, parameter_types: [*c]GType) ?*JSCValue;
pub extern fn jsc_class_add_constructor_variadic(jsc_class: ?*JSCClass, name: [*c]const u8, callback: GCallback, user_data: gpointer, destroy_notify: GDestroyNotify, return_type: GType) ?*JSCValue;
pub extern fn jsc_class_add_method(jsc_class: ?*JSCClass, name: [*c]const u8, callback: GCallback, user_data: gpointer, destroy_notify: GDestroyNotify, return_type: GType, n_params: guint, ...) void;
pub extern fn jsc_class_add_methodv(jsc_class: ?*JSCClass, name: [*c]const u8, callback: GCallback, user_data: gpointer, destroy_notify: GDestroyNotify, return_type: GType, n_parameters: guint, parameter_types: [*c]GType) void;
pub extern fn jsc_class_add_method_variadic(jsc_class: ?*JSCClass, name: [*c]const u8, callback: GCallback, user_data: gpointer, destroy_notify: GDestroyNotify, return_type: GType) void;
pub extern fn jsc_class_add_property(jsc_class: ?*JSCClass, name: [*c]const u8, property_type: GType, getter: GCallback, setter: GCallback, user_data: gpointer, destroy_notify: GDestroyNotify) void;
pub extern fn jsc_exception_get_type() GType;
pub const struct__JSCException = opaque {};
pub const JSCException = struct__JSCException;
pub const JSCExceptionClass = extern struct {
    parent_class: GObjectClass = @import("std").mem.zeroes(GObjectClass),
};
pub const JSCException_autoptr = ?*JSCException;
pub const JSCException_listautoptr = [*c]GList;
pub const JSCException_slistautoptr = [*c]GSList;
pub const JSCException_queueautoptr = [*c]GQueue;
pub fn glib_autoptr_clear_JSCException(arg__ptr: ?*JSCException) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    if (_ptr != null) {
        glib_autoptr_clear_GObject(@as([*c]GObject, @ptrCast(@alignCast(_ptr))));
...
pub fn glib_autoptr_cleanup_JSCException(arg__ptr: [*c]?*JSCException) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    glib_autoptr_clear_JSCException(_ptr.*);
}
pub fn glib_listautoptr_cleanup_JSCException(arg__l: [*c][*c]GList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_list_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&glib_autoptr_clear_GObject)))))));
}
pub fn glib_slistautoptr_cleanup_JSCException(arg__l: [*c][*c]GSList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_slist_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&glib_autoptr_clear_GObject)))))));
}
pub fn glib_queueautoptr_cleanup_JSCException(arg__q: [*c][*c]GQueue) callconv(.C) void {
    var _q = arg__q;
    _ = &_q;
    if (_q.* != null) {
        g_queue_free_full(_q.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&glib_autoptr_clear_GObject)))))));
...
pub const JSCExceptionClass_autoptr = [*c]JSCExceptionClass;
pub const JSCExceptionClass_listautoptr = [*c]GList;
pub const JSCExceptionClass_slistautoptr = [*c]GSList;
pub const JSCExceptionClass_queueautoptr = [*c]GQueue;
pub fn glib_autoptr_clear_JSCExceptionClass(arg__ptr: [*c]JSCExceptionClass) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    if (_ptr != null) {
        g_type_class_unref(@as(gpointer, @ptrCast(_ptr)));
...
pub fn glib_autoptr_cleanup_JSCExceptionClass(arg__ptr: [*c][*c]JSCExceptionClass) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    glib_autoptr_clear_JSCExceptionClass(_ptr.*);
}
pub fn glib_listautoptr_cleanup_JSCExceptionClass(arg__l: [*c][*c]GList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_list_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&g_type_class_unref)))))));
}
pub fn glib_slistautoptr_cleanup_JSCExceptionClass(arg__l: [*c][*c]GSList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_slist_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&g_type_class_unref)))))));
}
pub fn glib_queueautoptr_cleanup_JSCExceptionClass(arg__q: [*c][*c]GQueue) callconv(.C) void {
    var _q = arg__q;
    _ = &_q;
    if (_q.* != null) {
        g_queue_free_full(_q.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&g_type_class_unref)))))));
...
pub fn JSC_EXCEPTION(arg_ptr: gpointer) callconv(.C) ?*JSCException {
    var ptr = arg_ptr;
    _ = &ptr;
    return @as(?*JSCException, @ptrCast(@as(?*anyopaque, @ptrCast(g_type_check_instance_cast(@as([*c]GTypeInstance, @ptrCast(@alignCast(ptr))), jsc_exception_get_type())))));
}
pub fn JSC_IS_EXCEPTION(arg_ptr: gpointer) callconv(.C) gboolean {
    var ptr = arg_ptr;
    _ = &ptr;
    return blk: {
        var __inst: [*c]GTypeInstance = @as([*c]GTypeInstance, @ptrCast(@alignCast(ptr)));
        _ = &__inst;
        var __t: GType = jsc_exception_get_type();
        _ = &__t;
        var __r: gboolean = undefined;
        _ = &__r;
        if (!(__inst != null)) {
...
pub extern fn jsc_exception_new(context: ?*JSCContext, message: [*c]const u8) ?*JSCException;
pub extern fn jsc_exception_new_printf(context: ?*JSCContext, format: [*c]const u8, ...) ?*JSCException;
pub extern fn jsc_exception_new_vprintf(context: ?*JSCContext, format: [*c]const u8, args: [*c]struct___va_list_tag_6) ?*JSCException;
pub extern fn jsc_exception_new_with_name(context: ?*JSCContext, name: [*c]const u8, message: [*c]const u8) ?*JSCException;
pub extern fn jsc_exception_new_with_name_printf(context: ?*JSCContext, name: [*c]const u8, format: [*c]const u8, ...) ?*JSCException;
pub extern fn jsc_exception_new_with_name_vprintf(context: ?*JSCContext, name: [*c]const u8, format: [*c]const u8, args: [*c]struct___va_list_tag_6) ?*JSCException;
pub extern fn jsc_exception_get_name(exception: ?*JSCException) [*c]const u8;
pub extern fn jsc_exception_get_message(exception: ?*JSCException) [*c]const u8;
pub extern fn jsc_exception_get_line_number(exception: ?*JSCException) guint;
pub extern fn jsc_exception_get_column_number(exception: ?*JSCException) guint;
pub extern fn jsc_exception_get_source_uri(exception: ?*JSCException) [*c]const u8;
pub extern fn jsc_exception_get_backtrace_string(exception: ?*JSCException) [*c]const u8;
pub extern fn jsc_exception_to_string(exception: ?*JSCException) [*c]u8;
pub extern fn jsc_exception_report(exception: ?*JSCException) [*c]u8;
pub extern fn jsc_virtual_machine_get_type() GType;
pub const struct__JSCVirtualMachine = opaque {};
pub const JSCVirtualMachine = struct__JSCVirtualMachine;
pub const JSCVirtualMachineClass = extern struct {
    parent_class: GObjectClass = @import("std").mem.zeroes(GObjectClass),
};
pub const JSCVirtualMachine_autoptr = ?*JSCVirtualMachine;
pub const JSCVirtualMachine_listautoptr = [*c]GList;
pub const JSCVirtualMachine_slistautoptr = [*c]GSList;
pub const JSCVirtualMachine_queueautoptr = [*c]GQueue;
pub fn glib_autoptr_clear_JSCVirtualMachine(arg__ptr: ?*JSCVirtualMachine) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    if (_ptr != null) {
        glib_autoptr_clear_GObject(@as([*c]GObject, @ptrCast(@alignCast(_ptr))));
...
pub fn glib_autoptr_cleanup_JSCVirtualMachine(arg__ptr: [*c]?*JSCVirtualMachine) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    glib_autoptr_clear_JSCVirtualMachine(_ptr.*);
}
pub fn glib_listautoptr_cleanup_JSCVirtualMachine(arg__l: [*c][*c]GList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_list_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&glib_autoptr_clear_GObject)))))));
}
pub fn glib_slistautoptr_cleanup_JSCVirtualMachine(arg__l: [*c][*c]GSList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_slist_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&glib_autoptr_clear_GObject)))))));
}
pub fn glib_queueautoptr_cleanup_JSCVirtualMachine(arg__q: [*c][*c]GQueue) callconv(.C) void {
    var _q = arg__q;
    _ = &_q;
    if (_q.* != null) {
        g_queue_free_full(_q.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&glib_autoptr_clear_GObject)))))));
...
pub const JSCVirtualMachineClass_autoptr = [*c]JSCVirtualMachineClass;
pub const JSCVirtualMachineClass_listautoptr = [*c]GList;
pub const JSCVirtualMachineClass_slistautoptr = [*c]GSList;
pub const JSCVirtualMachineClass_queueautoptr = [*c]GQueue;
pub fn glib_autoptr_clear_JSCVirtualMachineClass(arg__ptr: [*c]JSCVirtualMachineClass) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    if (_ptr != null) {
        g_type_class_unref(@as(gpointer, @ptrCast(_ptr)));
...
pub fn glib_autoptr_cleanup_JSCVirtualMachineClass(arg__ptr: [*c][*c]JSCVirtualMachineClass) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    glib_autoptr_clear_JSCVirtualMachineClass(_ptr.*);
}
pub fn glib_listautoptr_cleanup_JSCVirtualMachineClass(arg__l: [*c][*c]GList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_list_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&g_type_class_unref)))))));
}
pub fn glib_slistautoptr_cleanup_JSCVirtualMachineClass(arg__l: [*c][*c]GSList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_slist_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&g_type_class_unref)))))));
}
pub fn glib_queueautoptr_cleanup_JSCVirtualMachineClass(arg__q: [*c][*c]GQueue) callconv(.C) void {
    var _q = arg__q;
    _ = &_q;
    if (_q.* != null) {
        g_queue_free_full(_q.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&g_type_class_unref)))))));
...
pub fn JSC_VIRTUAL_MACHINE(arg_ptr: gpointer) callconv(.C) ?*JSCVirtualMachine {
    var ptr = arg_ptr;
    _ = &ptr;
    return @as(?*JSCVirtualMachine, @ptrCast(@as(?*anyopaque, @ptrCast(g_type_check_instance_cast(@as([*c]GTypeInstance, @ptrCast(@alignCast(ptr))), jsc_virtual_machine_get_type())))));
}
pub fn JSC_IS_VIRTUAL_MACHINE(arg_ptr: gpointer) callconv(.C) gboolean {
    var ptr = arg_ptr;
    _ = &ptr;
    return blk: {
        var __inst: [*c]GTypeInstance = @as([*c]GTypeInstance, @ptrCast(@alignCast(ptr)));
        _ = &__inst;
        var __t: GType = jsc_virtual_machine_get_type();
        _ = &__t;
        var __r: gboolean = undefined;
        _ = &__r;
        if (!(__inst != null)) {
...
pub extern fn jsc_virtual_machine_new() ?*JSCVirtualMachine;
pub extern fn jsc_context_get_type() GType;
pub const JSCContextClass = extern struct {
    parent_class: GObjectClass = @import("std").mem.zeroes(GObjectClass),
};
pub const JSCContext_autoptr = ?*JSCContext;
pub const JSCContext_listautoptr = [*c]GList;
pub const JSCContext_slistautoptr = [*c]GSList;
pub const JSCContext_queueautoptr = [*c]GQueue;
pub fn glib_autoptr_clear_JSCContext(arg__ptr: ?*JSCContext) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    if (_ptr != null) {
        glib_autoptr_clear_GObject(@as([*c]GObject, @ptrCast(@alignCast(_ptr))));
...
pub fn glib_autoptr_cleanup_JSCContext(arg__ptr: [*c]?*JSCContext) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    glib_autoptr_clear_JSCContext(_ptr.*);
}
pub fn glib_listautoptr_cleanup_JSCContext(arg__l: [*c][*c]GList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_list_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&glib_autoptr_clear_GObject)))))));
}
pub fn glib_slistautoptr_cleanup_JSCContext(arg__l: [*c][*c]GSList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_slist_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&glib_autoptr_clear_GObject)))))));
}
pub fn glib_queueautoptr_cleanup_JSCContext(arg__q: [*c][*c]GQueue) callconv(.C) void {
    var _q = arg__q;
    _ = &_q;
    if (_q.* != null) {
        g_queue_free_full(_q.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&glib_autoptr_clear_GObject)))))));
...
pub const JSCContextClass_autoptr = [*c]JSCContextClass;
pub const JSCContextClass_listautoptr = [*c]GList;
pub const JSCContextClass_slistautoptr = [*c]GSList;
pub const JSCContextClass_queueautoptr = [*c]GQueue;
pub fn glib_autoptr_clear_JSCContextClass(arg__ptr: [*c]JSCContextClass) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    if (_ptr != null) {
        g_type_class_unref(@as(gpointer, @ptrCast(_ptr)));
...
pub fn glib_autoptr_cleanup_JSCContextClass(arg__ptr: [*c][*c]JSCContextClass) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    glib_autoptr_clear_JSCContextClass(_ptr.*);
}
pub fn glib_listautoptr_cleanup_JSCContextClass(arg__l: [*c][*c]GList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_list_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&g_type_class_unref)))))));
}
pub fn glib_slistautoptr_cleanup_JSCContextClass(arg__l: [*c][*c]GSList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_slist_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&g_type_class_unref)))))));
}
pub fn glib_queueautoptr_cleanup_JSCContextClass(arg__q: [*c][*c]GQueue) callconv(.C) void {
    var _q = arg__q;
    _ = &_q;
    if (_q.* != null) {
        g_queue_free_full(_q.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&g_type_class_unref)))))));
...
pub fn JSC_CONTEXT(arg_ptr: gpointer) callconv(.C) ?*JSCContext {
    var ptr = arg_ptr;
    _ = &ptr;
    return @as(?*JSCContext, @ptrCast(@as(?*anyopaque, @ptrCast(g_type_check_instance_cast(@as([*c]GTypeInstance, @ptrCast(@alignCast(ptr))), jsc_context_get_type())))));
}
pub fn JSC_IS_CONTEXT(arg_ptr: gpointer) callconv(.C) gboolean {
    var ptr = arg_ptr;
    _ = &ptr;
    return blk: {
        var __inst: [*c]GTypeInstance = @as([*c]GTypeInstance, @ptrCast(@alignCast(ptr)));
        _ = &__inst;
        var __t: GType = jsc_context_get_type();
        _ = &__t;
        var __r: gboolean = undefined;
        _ = &__r;
        if (!(__inst != null)) {
...
pub const JSCExceptionHandler = ?*const fn (?*JSCContext, ?*JSCException, gpointer) callconv(.C) void;
pub const JSC_CHECK_SYNTAX_MODE_SCRIPT: c_int = 0;
pub const JSC_CHECK_SYNTAX_MODE_MODULE: c_int = 1;
pub const JSCCheckSyntaxMode = c_uint;
pub const JSC_CHECK_SYNTAX_RESULT_SUCCESS: c_int = 0;
pub const JSC_CHECK_SYNTAX_RESULT_RECOVERABLE_ERROR: c_int = 1;
pub const JSC_CHECK_SYNTAX_RESULT_IRRECOVERABLE_ERROR: c_int = 2;
pub const JSC_CHECK_SYNTAX_RESULT_UNTERMINATED_LITERAL_ERROR: c_int = 3;
pub const JSC_CHECK_SYNTAX_RESULT_OUT_OF_MEMORY_ERROR: c_int = 4;
pub const JSC_CHECK_SYNTAX_RESULT_STACK_OVERFLOW_ERROR: c_int = 5;
pub const JSCCheckSyntaxResult = c_uint;
pub extern fn jsc_context_new() ?*JSCContext;
pub extern fn jsc_context_new_with_virtual_machine(vm: ?*JSCVirtualMachine) ?*JSCContext;
pub extern fn jsc_context_get_virtual_machine(context: ?*JSCContext) ?*JSCVirtualMachine;
pub extern fn jsc_context_get_exception(context: ?*JSCContext) ?*JSCException;
pub extern fn jsc_context_throw(context: ?*JSCContext, error_message: [*c]const u8) void;
pub extern fn jsc_context_throw_printf(context: ?*JSCContext, format: [*c]const u8, ...) void;
pub extern fn jsc_context_throw_with_name(context: ?*JSCContext, error_name: [*c]const u8, error_message: [*c]const u8) void;
pub extern fn jsc_context_throw_with_name_printf(context: ?*JSCContext, error_name: [*c]const u8, format: [*c]const u8, ...) void;
pub extern fn jsc_context_throw_exception(context: ?*JSCContext, exception: ?*JSCException) void;
pub extern fn jsc_context_clear_exception(context: ?*JSCContext) void;
pub extern fn jsc_context_push_exception_handler(context: ?*JSCContext, handler: JSCExceptionHandler, user_data: gpointer, destroy_notify: GDestroyNotify) void;
pub extern fn jsc_context_pop_exception_handler(context: ?*JSCContext) void;
pub extern fn jsc_context_get_current() ?*JSCContext;
pub extern fn jsc_context_evaluate(context: ?*JSCContext, code: [*c]const u8, length: gssize) ?*JSCValue;
pub extern fn jsc_context_evaluate_with_source_uri(context: ?*JSCContext, code: [*c]const u8, length: gssize, uri: [*c]const u8, line_number: guint) ?*JSCValue;
pub extern fn jsc_context_evaluate_in_object(context: ?*JSCContext, code: [*c]const u8, length: gssize, object_instance: gpointer, object_class: ?*JSCClass, uri: [*c]const u8, line_number: guint, object: [*c]?*JSCValue) ?*JSCValue;
pub extern fn jsc_context_check_syntax(context: ?*JSCContext, code: [*c]const u8, length: gssize, mode: JSCCheckSyntaxMode, uri: [*c]const u8, line_number: c_uint, exception: [*c]?*JSCException) JSCCheckSyntaxResult;
pub extern fn jsc_context_get_global_object(context: ?*JSCContext) ?*JSCValue;
pub extern fn jsc_context_set_value(context: ?*JSCContext, name: [*c]const u8, value: ?*JSCValue) void;
pub extern fn jsc_context_get_value(context: ?*JSCContext, name: [*c]const u8) ?*JSCValue;
pub extern fn jsc_context_register_class(context: ?*JSCContext, name: [*c]const u8, parent_class: ?*JSCClass, vtable: [*c]JSCClassVTable, destroy_notify: GDestroyNotify) ?*JSCClass;
pub extern fn jsc_options_set_boolean(option: [*c]const u8, value: gboolean) gboolean;
pub extern fn jsc_options_get_boolean(option: [*c]const u8, value: [*c]gboolean) gboolean;
pub extern fn jsc_options_set_int(option: [*c]const u8, value: gint) gboolean;
pub extern fn jsc_options_get_int(option: [*c]const u8, value: [*c]gint) gboolean;
pub extern fn jsc_options_set_uint(option: [*c]const u8, value: guint) gboolean;
pub extern fn jsc_options_get_uint(option: [*c]const u8, value: [*c]guint) gboolean;
pub extern fn jsc_options_set_size(option: [*c]const u8, value: gsize) gboolean;
pub extern fn jsc_options_get_size(option: [*c]const u8, value: [*c]gsize) gboolean;
pub extern fn jsc_options_set_double(option: [*c]const u8, value: gdouble) gboolean;
pub extern fn jsc_options_get_double(option: [*c]const u8, value: [*c]gdouble) gboolean;
pub extern fn jsc_options_set_string(option: [*c]const u8, value: [*c]const u8) gboolean;
pub extern fn jsc_options_get_string(option: [*c]const u8, value: [*c][*c]u8) gboolean;
pub extern fn jsc_options_set_range_string(option: [*c]const u8, value: [*c]const u8) gboolean;
pub extern fn jsc_options_get_range_string(option: [*c]const u8, value: [*c][*c]u8) gboolean;
pub const JSC_OPTION_BOOLEAN: c_int = 0;
pub const JSC_OPTION_INT: c_int = 1;
pub const JSC_OPTION_UINT: c_int = 2;
pub const JSC_OPTION_SIZE: c_int = 3;
pub const JSC_OPTION_DOUBLE: c_int = 4;
pub const JSC_OPTION_STRING: c_int = 5;
pub const JSC_OPTION_RANGE_STRING: c_int = 6;
pub const JSCOptionType = c_uint;
pub const JSCOptionsFunc = ?*const fn ([*c]const u8, JSCOptionType, [*c]const u8, gpointer) callconv(.C) gboolean;
pub extern fn jsc_options_foreach(function: JSCOptionsFunc, user_data: gpointer) void;
pub extern fn jsc_options_get_option_group() ?*GOptionGroup;
pub extern fn jsc_get_major_version() guint;
pub extern fn jsc_get_minor_version() guint;
pub extern fn jsc_get_micro_version() guint;
pub extern fn jsc_weak_value_get_type() GType;
pub const struct__JSCWeakValue = opaque {};
pub const JSCWeakValue = struct__JSCWeakValue;
pub const JSCWeakValueClass = extern struct {
    parent_class: GObjectClass = @import("std").mem.zeroes(GObjectClass),
};
pub const JSCWeakValue_autoptr = ?*JSCWeakValue;
pub const JSCWeakValue_listautoptr = [*c]GList;
pub const JSCWeakValue_slistautoptr = [*c]GSList;
pub const JSCWeakValue_queueautoptr = [*c]GQueue;
pub fn glib_autoptr_clear_JSCWeakValue(arg__ptr: ?*JSCWeakValue) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    if (_ptr != null) {
        glib_autoptr_clear_GObject(@as([*c]GObject, @ptrCast(@alignCast(_ptr))));
...
pub fn glib_autoptr_cleanup_JSCWeakValue(arg__ptr: [*c]?*JSCWeakValue) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    glib_autoptr_clear_JSCWeakValue(_ptr.*);
}
pub fn glib_listautoptr_cleanup_JSCWeakValue(arg__l: [*c][*c]GList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_list_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&glib_autoptr_clear_GObject)))))));
}
pub fn glib_slistautoptr_cleanup_JSCWeakValue(arg__l: [*c][*c]GSList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_slist_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&glib_autoptr_clear_GObject)))))));
}
pub fn glib_queueautoptr_cleanup_JSCWeakValue(arg__q: [*c][*c]GQueue) callconv(.C) void {
    var _q = arg__q;
    _ = &_q;
    if (_q.* != null) {
        g_queue_free_full(_q.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&glib_autoptr_clear_GObject)))))));
...
pub const JSCWeakValueClass_autoptr = [*c]JSCWeakValueClass;
pub const JSCWeakValueClass_listautoptr = [*c]GList;
pub const JSCWeakValueClass_slistautoptr = [*c]GSList;
pub const JSCWeakValueClass_queueautoptr = [*c]GQueue;
pub fn glib_autoptr_clear_JSCWeakValueClass(arg__ptr: [*c]JSCWeakValueClass) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    if (_ptr != null) {
        g_type_class_unref(@as(gpointer, @ptrCast(_ptr)));
...
pub fn glib_autoptr_cleanup_JSCWeakValueClass(arg__ptr: [*c][*c]JSCWeakValueClass) callconv(.C) void {
    var _ptr = arg__ptr;
    _ = &_ptr;
    glib_autoptr_clear_JSCWeakValueClass(_ptr.*);
}
pub fn glib_listautoptr_cleanup_JSCWeakValueClass(arg__l: [*c][*c]GList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_list_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&g_type_class_unref)))))));
}
pub fn glib_slistautoptr_cleanup_JSCWeakValueClass(arg__l: [*c][*c]GSList) callconv(.C) void {
    var _l = arg__l;
    _ = &_l;
    g_slist_free_full(_l.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&g_type_class_unref)))))));
}
pub fn glib_queueautoptr_cleanup_JSCWeakValueClass(arg__q: [*c][*c]GQueue) callconv(.C) void {
    var _q = arg__q;
    _ = &_q;
    if (_q.* != null) {
        g_queue_free_full(_q.*, @as(GDestroyNotify, @ptrCast(@alignCast(@as(?*const fn () callconv(.C) void, @ptrCast(@alignCast(&g_type_class_unref)))))));
...
pub fn JSC_WEAK_VALUE(arg_ptr: gpointer) callconv(.C) ?*JSCWeakValue {
    var ptr = arg_ptr;
    _ = &ptr;
    return @as(?*JSCWeakValue, @ptrCast(@as(?*anyopaque, @ptrCast(g_type_check_instance_cast(@as([*c]GTypeInstance, @ptrCast(@alignCast(ptr))), jsc_weak_value_get_type())))));
}
pub fn JSC_IS_WEAK_VALUE(arg_ptr: gpointer) callconv(.C) gboolean {
    var ptr = arg_ptr;
    _ = &ptr;
    return blk: {
        var __inst: [*c]GTypeInstance = @as([*c]GTypeInstance, @ptrCast(@alignCast(ptr)));
        _ = &__inst;
        var __t: GType = jsc_weak_value_get_type();
        _ = &__t;
        var __r: gboolean = undefined;
        _ = &__r;
        if (!(__inst != null)) {
...
pub extern fn jsc_weak_value_new(value: ?*JSCValue) ?*JSCWeakValue;
pub extern fn jsc_weak_value_get_value(weak_value: ?*JSCWeakValue) ?*JSCValue;
...
pub const __JSC_H__ = "";
pub const __JSC_H_INSIDE__ = "";
pub const JSCClass_h = "";
...
// /home/mr9madness/zig/0.13.0/files/lib/include/float.h:91:9
pub const FLT_ROUNDS = @compileError("unable to translate macro: undefined identifier `__builtin_flt_rounds`");
// /home/mr9madness/zig/0.13.0/files/lib/include/float.h:93:9
...
// /usr/lib/x86_64-linux-gnu/glib-2.0/include/glibconfig.h:151:9
...
// /home/mr9madness/zig/0.13.0/files/lib/include/__stdarg_va_arg.h:17:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`");
// /home/mr9madness/zig/0.13.0/files/lib/include/__stdarg_va_arg.h:19:9
pub const va_arg = @compileError("unable to translate C expr: unexpected token 'an identifier'");
// /home/mr9madness/zig/0.13.0/files/lib/include/__stdarg_va_arg.h:20:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`");
// /home/mr9madness/zig/0.13.0/files/lib/include/__stdarg___va_copy.h:11:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`");
// /home/mr9madness/zig/0.13.0/files/lib/include/__stdarg_va_copy.h:11:9
...
// /usr/include/glib-2.0/gobject/gtype.h:2179:9
...
// /usr/include/glib-2.0/gobject/gtype.h:2467:9
pub const _G_TYPE_IGI = @compileError("unable to translate C expr: unexpected token ')'");
// /usr/include/glib-2.0/gobject/gtype.h:2468:9
...
// /usr/include/glib-2.0/gobject/gvalue.h:205:9
...
// /usr/include/glib-2.0/gobject/gobject.h:676:9
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:39:9: warning: macro 'G_TYPE_PARAM_CHAR' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:62:9: warning: macro 'G_TYPE_PARAM_UCHAR' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:85:9: warning: macro 'G_TYPE_PARAM_BOOLEAN' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:108:9: warning: macro 'G_TYPE_PARAM_INT' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:131:9: warning: macro 'G_TYPE_PARAM_UINT' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:154:9: warning: macro 'G_TYPE_PARAM_LONG' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:177:9: warning: macro 'G_TYPE_PARAM_ULONG' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:200:9: warning: macro 'G_TYPE_PARAM_INT64' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:223:9: warning: macro 'G_TYPE_PARAM_UINT64' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:246:9: warning: macro 'G_TYPE_PARAM_UNICHAR' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:269:9: warning: macro 'G_TYPE_PARAM_ENUM' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:292:9: warning: macro 'G_TYPE_PARAM_FLAGS' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:315:9: warning: macro 'G_TYPE_PARAM_FLOAT' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:338:9: warning: macro 'G_TYPE_PARAM_DOUBLE' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:361:9: warning: macro 'G_TYPE_PARAM_STRING' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:384:9: warning: macro 'G_TYPE_PARAM_PARAM' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:407:9: warning: macro 'G_TYPE_PARAM_BOXED' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:430:9: warning: macro 'G_TYPE_PARAM_POINTER' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:455:9: warning: macro 'G_TYPE_PARAM_VALUE_ARRAY' contains a runtime value, translated to function
pub inline fn G_TYPE_PARAM_VALUE_ARRAY() @TypeOf(g_param_spec_types[@as(usize, @intCast(@as(c_int, 18)))] ++ GLIB_DEPRECATED_MACRO_IN_2_32) {
    return g_param_spec_types[@as(usize, @intCast(@as(c_int, 18)))] ++ GLIB_DEPRECATED_MACRO_IN_2_32;
}
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:482:9: warning: macro 'G_TYPE_PARAM_OBJECT' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:507:9: warning: macro 'G_TYPE_PARAM_OVERRIDE' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:535:9: warning: macro 'G_TYPE_PARAM_GTYPE' contains a runtime value, translated to function
...
// /usr/include/glib-2.0/gobject/gparamspecs.h:563:9: warning: macro 'G_TYPE_PARAM_VARIANT' contains a runtime value, translated to function
...
pub const JSCDefines_h = "";
pub const JSC_API = @compileError("unable to translate macro: undefined identifier `visibility`");
// /usr/include/webkitgtk-6.0/jsc/JSCDefines.h:42:13
pub const JSC_DEPRECATED = JSC_API ++ G_DEPRECATED;
pub inline fn JSC_DEPRECATED_FOR(f: anytype) @TypeOf(JSC_API ++ G_DEPRECATED_FOR(f)) {
    _ = &f;
    return JSC_API ++ G_DEPRECATED_FOR(f);
}
pub inline fn JSC_DECLARE_FINAL_TYPE(ModuleObjName: anytype, module_obj_name: anytype, MODULE: anytype, OBJ_NAME: anytype, ParentName: anytype) @TypeOf(JSC_API ++ G_DECLARE_FINAL_TYPE(ModuleObjName, module_obj_name, MODULE, OBJ_NAME, ParentName)) {
    _ = &ModuleObjName;
    _ = &module_obj_name;
    _ = &MODULE;
    _ = &OBJ_NAME;
    _ = &ParentName;
    return JSC_API ++ G_DECLARE_FINAL_TYPE(ModuleObjName, module_obj_name, MODULE, OBJ_NAME, ParentName);
}
pub const JSCValue_h = "";
pub const JSC_TYPE_VALUE = jsc_value_get_type();
pub const JSC_TYPE_CLASS = jsc_class_get_type();
pub const JSCContext_h = "";
pub const JSCException_h = "";
pub const JSC_TYPE_EXCEPTION = jsc_exception_get_type();
pub const JSCVirtualMachine_h = "";
pub const JSC_TYPE_VIRTUAL_MACHINE = jsc_virtual_machine_get_type();
pub const JSC_TYPE_CONTEXT = jsc_context_get_type();
pub const JSCOptions_h = "";
pub const JSC_OPTIONS_USE_JIT = "useJIT";
pub const JSC_OPTIONS_USE_DFG = "useDFGJIT";
pub const JSC_OPTIONS_USE_FTL = "useFTLJIT";
pub const JSC_OPTIONS_USE_LLINT = "useLLInt";
pub const JSCVersion_h = "";
pub const JSC_MAJOR_VERSION = @as(c_int, 2);
pub const JSC_MINOR_VERSION = @as(c_int, 44);
pub const JSC_MICRO_VERSION = @as(c_int, 2);
pub inline fn JSC_CHECK_VERSION(major: anytype, minor: anytype, micro: anytype) @TypeOf(((JSC_MAJOR_VERSION > major) or ((JSC_MAJOR_VERSION == major) and (JSC_MINOR_VERSION > minor))) or (((JSC_MAJOR_VERSION == major) and (JSC_MINOR_VERSION == minor)) and (JSC_MICRO_VERSION >= micro))) {
    _ = &major;
    _ = &minor;
    _ = &micro;
    return ((JSC_MAJOR_VERSION > major) or ((JSC_MAJOR_VERSION == major) and (JSC_MINOR_VERSION > minor))) or (((JSC_MAJOR_VERSION == major) and (JSC_MINOR_VERSION == minor)) and (JSC_MICRO_VERSION >= micro));
}
pub const JSCWeakValue_h = "";
pub const JSC_TYPE_WEAK_VALUE = jsc_weak_value_get_type();
...
pub const _JSCValue = struct__JSCValue;
pub const _JSCClass = struct__JSCClass;
pub const _JSCContext = struct__JSCContext;
pub const _JSCException = struct__JSCException;
pub const _JSCVirtualMachine = struct__JSCVirtualMachine;
pub const _JSCWeakValue = struct__JSCWeakValue;
